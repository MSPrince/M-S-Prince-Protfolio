...
const Hero = () => {
  ...
  return (
    <div className="w-full">
      ...
      md:text-[2.2rem] lg:text-[5.5rem] tracking-[2px] mb-4 font-bold gradient-text pinkSunset"
      >
        Hey, I'm M S Prince
      </h1>
      <h1
        className="text-tubeLight-effect overflow-x-hidden text-[1.3rem] 
      sm:text-[1.75rem] md:text-[2.2rem] lg:text-[2.3rem] tracking-[15px]"
      >
        <Typewriter
          words={["FULLSTACK WEB DEVELOPER", "Health Adviser", "FREELANCER" , "Owner Of A Doctor's Diary"]}
          loop={50}
          cursor
          typeSpeed={70}
          deleteSpeed={50}
